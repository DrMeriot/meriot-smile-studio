...
const content = {
  ...
  faqList: keyed([
    ...
    { question: `Mes gencives saignent pendant ma grossesse, que faire ?`, answer: `Les variations hormonales rendent les gencives plus sensibles : la gingivite de grossesse touche jusqu'à 70 % des femmes enceintes. C'est fréquent et réversible. Bonne nouvelle : un examen bucco-dentaire de prévention est pris en charge à 100 % par l'Assurance Maladie dès le 4e mois de grossesse. Un détartrage et un suivi doux suffisent le plus souvent. J'accompagne les femmes enceintes en toute sécurité, à leur rythme.` },
    { question: `Je fume et mes gencives saignent, est-ce plus grave ?`, answer: `Le tabac masque le saignement en réduisant la circulation dans la gencive : une maladie des gencives peut donc progresser sans que vous la voyiez. Les fumeurs ont 3 à 6 fois plus de risque de parodontite sévère. Si vos gencives saignent malgré le tabac, c'est un signal à ne pas négliger. Réduire le tabac, même progressivement, améliore nettement la santé de vos gencives — je vous accompagne sans jugement.` },
  ]),
