...
const ContactPage = () => {
  ...
  const seoTitle = page?.seoTitle ?? "Contact & Accès | Cabinet Dentaire Dr Meriot Marseille 4ème";
  const seoDesc = page?.seoDescription ?? "Cabinet dentaire Dr Stéphanie Meriot à Marseille 4ème. 23 Bd de la Fédération, métro Chartreux. Doctolib ☎ 09 83 43 96 21. Carte Vitale, tiers payant.";
          ...
          <section className="py-16 bg-gradient-soft">
            <div className="container mx-auto px-4 text-center">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                {page?.heroTitle ?? "Contact & Accès"}
              </h1>
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                {page?.heroSubtitle ?? "Le cabinet du Dr Stéphanie Mériot est situé à Marseille 4ème, à proximité du métro Chartreux. Nous accueillons des patients de Marseille et de toute la région PACA."}
              </p>
            </div>
          </section>
          <Contact />
