...
const Esthetique = () => {
  ...
  const solutions = page?.solutionsList ?? defaultSolutions;
  const seoTitle = page?.seoTitle ?? "Esthétique Dentaire Marseille | Blanchiment & Facettes | Dr Meriot";
  const seoDesc = page?.seoDescription ?? `Blanchiment dentaire, facettes et composites esthétiques à Marseille 4ème. Retrouvez un sourire éclatant avec le Dr Meriot. ☎ ${tel}`;
        ...
        <main className="pt-20">
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                  {page?.heroTitle ?? "Esthétique dentaire à Marseille"}
                </h1>
                <p className="text-xl text-muted-foreground leading-relaxed">
                  {page?.heroSubtitle ?? "Retrouvez un sourire éclatant et harmonieux grâce à des solutions esthétiques douces et personnalisées. Sublimez votre sourire en toute sérénité."}
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="py-20">
            <div className="container mx-auto px-4 max-w-4xl">
              <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center">{page?.introTitre ?? "Un sourire qui vous ressemble"}</h2>
              <div className="prose prose-lg max-w-none">
                <p className="text-muted-foreground leading-relaxed mb-6">
                  {page?.introTexte1 ?? "L'esthétique dentaire ne se limite pas à avoir des dents blanches. C'est avant tout retrouver confiance en soi et se sentir bien avec son sourire."}
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  {page?.introTexte2 ?? "Mon approche est naturelle et respectueuse de vos tissus dentaires. Je privilégie toujours les techniques les moins invasives pour préserver au maximum votre émail."}
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="py-20 bg-muted/30">
            <div className="container mx-auto px-4 max-w-5xl">
              <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center">{page?.solutionsTitre ?? "Nos solutions d'esthétique dentaire"}</h2>
              <div className="space-y-8">
                {solutions.map((s: { title: string; desc: string; items: string[]; color?: string }, i: number) => {
                    ...
                    <Card key={i} className="shadow-soft hover-lift transition-all duration-300">
                      <CardContent className="pt-6">
                        <div className="flex gap-6 items-start">
                          <div className={`p-3 bg-${color}/10 rounded-xl flex-shrink-0`}>
                            <Sparkles className={`h-6 w-6 text-${color}`} />
                          </div>
                            ...
                            <ul className="space-y-2">
                              {s.items.map((item: string, j: number) => (
                                <li key={j} className="flex items-start gap-2">
                                  <CheckCircle2 className={`h-5 w-5 text-${color} flex-shrink-0 mt-0.5`} />
          ...
          <section className="py-20">
            <div className="container mx-auto px-4 max-w-4xl">
              <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center">{page?.approcheTitre ?? "Une approche esthétique naturelle et respectueuse"}</h2>
              <div className="bg-card rounded-2xl p-8 shadow-soft">
                <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                  {page?.approcheTexte1 ?? "Je crois en une esthétique naturelle qui respecte votre personnalité et vos traits. Mon objectif n'est pas de créer un sourire \"parfait\" standardisé, mais de sublimer votre sourire unique."}
                </p>
                <p className="text-lg text-muted-foreground leading-relaxed">
                  {page?.approcheTexte2 ?? "Ma philosophie : dentisterie à minima. Je privilégie toujours les techniques les moins invasives pour préserver au maximum vos tissus dentaires naturels."}
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="py-20 bg-accent/5">
            <div className="container mx-auto px-4 text-center">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">{page?.ctaTitre ?? "Osez le sourire dont vous rêvez"}</h2>
              <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                {page?.ctaTexte ?? "Prenez rendez-vous pour une consultation esthétique. Ensemble, nous créerons le sourire qui vous correspond."}
              </p>
