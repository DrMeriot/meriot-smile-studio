...
const services: ServiceItem[] = [
  ...
  },
  {
    ...
    description:
      "Traitement des maladies des gencives, détartrage approfondi, chirurgie parodontale, greffe gingivale. Découvrez aussi mes pages dédiées à la gingivite et au déchaussement dentaire.",
    color: "text-accent",
